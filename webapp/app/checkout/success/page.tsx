...
import { CheckCircle, ArrowRight, Download, Sparkles, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            <a href="mailto:support@smartmenu.nz" className="text-orange-500 hover:underline font-semibold">
              support@smartmenu.nz
            </a>
          </p>
